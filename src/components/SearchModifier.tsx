...
export function SearchModifier({ onTitlesChange, currentTitles, translations }: SearchModifierProps) {
  ...
  // Diverse job titles across different fields
  const defaultTitles = [
    // ... (previous titles remain the same)
  ];
  ...
  return (
    <div className="relative mb-12">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-4 p-6 bg-white dark:bg-gray-800 rounded-xl shadow-xl z-50 border border-gray-200 dark:border-gray-700">
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap gap-3 max-h-48 overflow-y-auto p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
